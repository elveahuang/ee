package cn.elvea.platform.commons.core.data.core.utils;

import cn.elvea.platform.commons.core.data.core.dialect.DbDialect;
import cn.elvea.platform.commons.core.data.core.dialect.DbMySqlDialect;
import cn.elvea.platform.commons.core.data.core.dialect.DbPostgresDialect;
...
public abstract class JdbcUtils {
    ...
    public static String createTemporaryTable(Connection con, List<Long> data) throws SQLException {
        return createTemporaryTable(con, data, DEFAULT_BATCH_SIZE);
    }
