...
public abstract class DateUtils {
    ...
    public static Date parseDate(String text) {
        return parse(text, Pattern.DATE, TIME_ZONE_DEFAULT);
    }
    ...
    public static String getPattern(Pattern pattern) {
        return switch (pattern) {
            case TIME -> DEFAULT_TIME_PATTERN;
            case SIMPLE_TIME -> DEFAULT_SIMPLE_TIME_PATTERN;
            case FULL_TIME -> DEFAULT_FULL_TIME_PATTERN;
            case DATE_TIME -> DEFAULT_DATE_TIME_PATTERN;
            case SIMPLE_DATE_TIME -> DEFAULT_SIMPLE_DATE_TIME_PATTERN;
            case FULL_DATE_TIME -> DEFAULT_FULL_DATE_TIME_PATTERN;
            case DATE -> DEFAULT_DATE_PATTERN;
