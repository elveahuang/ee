...
public class User implements UserDetails, OAuth2AuthenticatedPrincipal, Serializable {
    ...
    public User(Long id, String userType, String username, String password,
        ...
        this(0L, id, userType, username, password, authorities, true, true, true, true);
    }

    public User(Long tenantId, Long id, String userType, String username, String password,
                Set<GrantedAuthority> authorities) {
        this(tenantId, id, userType, username, password, authorities, true, true, true, true);
    }
