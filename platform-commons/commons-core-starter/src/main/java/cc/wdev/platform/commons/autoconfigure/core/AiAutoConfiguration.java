...
import cc.wdev.platform.commons.core.ai.aliyun.AiAliyunManagerImpl;
...
import cc.wdev.platform.commons.core.ai.tencent.AiTencentManagerImpl;
...
public class AiAutoConfiguration {
    ...
    public AiTencentManager aiTencentFactory(AiTencentProperties properties) {
        AiTencentConfig config = AiTencentConfig.builder().apiKey(properties.getApiKey()).build();
        return new AiTencentManagerImpl(config);
    }
    ...
    public AiAliyunManager aiAliyunFactory(AiAliyunProperties properties) {
        AiAliyunConfig config = AiAliyunConfig.builder()
            .apiKey(properties.getApiKey())
            .transcription(properties.getTranscription())
            .build();
        return new AiAliyunManagerImpl(config);
    }
