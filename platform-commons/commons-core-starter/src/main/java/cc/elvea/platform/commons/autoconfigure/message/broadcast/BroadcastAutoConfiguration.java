package cc.elvea.platform.commons.autoconfigure.message.broadcast;

import cc.elvea.platform.commons.autoconfigure.message.broadcast.properties.BroadcastProperties;
...
@Import({BroadcastRabbitAutoConfiguration.class, BroadcastRedissonAutoConfiguration.class,})
