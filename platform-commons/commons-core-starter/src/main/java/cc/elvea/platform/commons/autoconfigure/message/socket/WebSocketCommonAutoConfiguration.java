package cc.elvea.platform.commons.autoconfigure.message.socket;

import cc.elvea.platform.commons.autoconfigure.message.socket.properties.WebSocketProperties;
