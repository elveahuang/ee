...
import top.baihu.platform.commons.autoconfigure.message.properties.BroadcastProperties;
import top.baihu.platform.commons.message.broadcast.manager.DefaultBroadcastManager;
