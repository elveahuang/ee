...
import top.baihu.platform.commons.autoconfigure.data.properties.JpaCustomProperties;
import top.baihu.platform.commons.data.jpa.id.CustomIdentifierGenerator;
