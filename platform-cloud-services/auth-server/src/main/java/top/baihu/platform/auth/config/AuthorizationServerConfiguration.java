package top.baihu.platform.auth.config;
...
import top.baihu.platform.auth.security.authentication.*;

import java.util.List;
import java.util.function.Function;

import static top.baihu.platform.commons.constants.SecurityConstants.*;
