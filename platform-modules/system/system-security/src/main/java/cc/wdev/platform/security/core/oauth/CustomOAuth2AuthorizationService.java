...
public class CustomOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public void save(OAuth2Authorization authorization) {
        ...
        try {
            ...
            String identityType = AuthContext.getIdentityType();
            log.info("Identity type: {}", identityType);

            if (user != null) {
                Long entityType = "account".equals(identityType) ? 2L : 1L;
                ...
                LoginSessionDto loginSession = LoginSessionDto.builder()
                    ...
                    .success(BooleanTypeEnum.TRUE.getValue())
                    ...
                    .build();
                this.loginSessionApi.saveUserSession(loginSession);
            }
        } catch (Exception e) {
            log.error("Failed to save LoginSession.", e);
        }
    }
