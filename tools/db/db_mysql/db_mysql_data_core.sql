...
values
    ...
    (2000020, 1001006, 'session:online', '在线用户', 2, 2, 1, 1),
    (2000021, 1001006, 'logging:operation', '操作日志', 2, 2, 5, 1),
    (2000022, 1001006, 'logging:login', '登录日志', 2, 2, 5, 1),
    (2000023, 1001005, 'message:setting', '基本设置', 2, 2, 5, 1),
    (2000024, 1001005, 'message:template', '消息模版', 2, 2, 5, 1),
    (2000025, 1001005, 'message:logging', '消息日志', 2, 2, 5, 1),
    /* -------- 平台设置 -------- */
    ...
    (2001017, 1001010, 'platform:tenant:logging', '租户日志', 2, 1, 4, 1),
    ...
    (2001021, 1001011, 'platform:member:logging', '会员日志', 2, 1, 4, 1),
    (2001022, 1001012, 'platform:session:online', '在线用户', 2, 1, 1, 1),
    (2001023, 1001012, 'platform:logging:operation', '操作日志', 2, 1, 5, 1),
    (2001024, 1001012, 'platform:logging:login', '登录日志', 2, 1, 5, 1),
    /* -------- 开放平台 -------- */
    ...
    (2004011, 1001023, 'development:monitor:logging', '日志中心', 2, 1, 5, 1),
