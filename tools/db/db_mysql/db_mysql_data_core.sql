...
-- 1001000 - GROUP      - 分组（标准）
-- 2000000 - RESOURCE   - 资源（标准） - 基础功能
-- 2001000 - RESOURCE   - 资源（标准） - 平台功能
-- 2002000 - RESOURCE   - 资源（标准） - 开放平台
-- 2003000 - RESOURCE   - 资源（标准） - 数据统计
-- 2004000 - RESOURCE   - 资源（标准） - 开发工具
-- 2005000 - RESOURCE   - 资源（标准） - 商城功能
...
insert into sys_authority (`id`, `parent_id`, `code`, `title`, `authority_type`, `authority_group_type`, `authority_biz_type`, `idx`, `active`)
values
    /* ================ 版块 ================ */
    (1000001, 0, 'module:home', '首页', 1, 2, 1, 555, 1),
    (1000002, 0, 'module:system', '系统管理', 1, 2, 1, 777, 1),
    (1000003, 0, 'module:platform', '平台管理', 1, 1, 1, 888, 1),
    (1000004, 0, 'module:open', '开放平台', 1, 2, 1, 666, 1),
    (1000005, 0, 'module:development', '开发管理', 1, 1, 1, 999, 1),
    (1000006, 0, 'module:data', '数据分析', 1, 1, 1, 999, 1),
    /* ================ 分组 ================ */
    (1001001, 1000002, 'group:system:workbench', '工作台', 2, 2, 1, 33, 1),
    (1001002, 1000002, 'group:system:site', '站点管理', 2, 2, 1, 33, 1),
    (1001003, 1000002, 'group:system:organization', '组织架构', 4, 2, 1, 88, 1),
    (1001004, 1000002, 'group:system:setting', '系统设置', 5, 2, 1, 99, 1),
    (1001005, 1000002, 'group:system:message', '消息管理', 5, 2, 1, 99, 1),
    (1001006, 1000002, 'group:system:monitor', '系统监控', 5, 2, 1, 99, 1),
    (1001007, 1000002, 'group:system:open', '开放平台', 5, 2, 1, 99, 0),
    (1001008, 1000002, 'group:platform:workbench', '工作台', 2, 2, 1, 33, 1),
    (1001009, 1000002, 'group:platform:setting', '平台设置', 2, 2, 1, 33, 1),
    (1001010, 1000002, 'group:platform:tenant', '租户管理', 2, 2, 1, 33, 1),
    (1001011, 1000002, 'group:platform:member', '会员管理', 2, 2, 1, 33, 1),
    (1001012, 1000002, 'group:platform:monitor', '平台监控', 2, 2, 1, 33, 1),
    (1001013, 1000006, 'group:data:analysis', '数据分析', 2, 2, 1, 11, 0),
    (1001014, 1000006, 'group:data:report', '数据报表', 2, 2, 1, 11, 0),
    (1001015, 1000004, 'group:open:wechat:mp', '微信公众号管理', 3, 2, 1, 33, 1),
    (1001016, 1000004, 'group:open:wechat:ma', '微信小程序管理', 3, 2, 1, 33, 1),
    (1001017, 1000004, 'group:open:alipay:ma', '支付宝小程序管理', 3, 2, 1, 33, 0),
    (1001018, 1000004, 'group:open:douyin:ma', '抖音小程序管理', 3, 2, 1, 33, 0),
    (1001019, 1000004, 'group:open:kuaishou:ma', '快手小程序管理', 3, 2, 1, 33, 0),
    (1001020, 1000004, 'group:open:xiaohongshu:ma', '小红书小程序管理', 3, 2, 1, 33, 0),
    (1001021, 1000005, 'group:development:tools', '开发工具', 3, 2, 1, 33, 0),
    (1001022, 1000005, 'group:development:gateway', '网关管理', 3, 2, 1, 33, 0),
    (1001023, 1000005, 'group:development:monitor', '平台监控', 3, 2, 1, 33, 0),
    /* ================ 模块 ================ */
    /* -------- 基础模块 -------- */
    (2000001, 1001001, 'workbench', '工作台', 1, 2, 1, 11, 1),
    (2000002, 1001001, 'dashboard', '仪表盘', 1, 2, 1, 11, 1),
    (2000003, 1001002, 'announcement', '公告管理', 2, 2, 1, 11, 1),
    (2000004, 1001002, 'banner', '公告管理', 2, 2, 1, 22, 1),
    (2000005, 1001003, 'organization', '组织架构', 2, 2, 1, 1, 1),
    (2000006, 1001003, 'user', '用户管理', 2, 2, 1, 3, 1),
    (2000007, 1001003, 'group', '群组管理', 2, 2, 1, 4, 1),
    (2000008, 1001003, 'position', '岗位管理', 2, 2, 1, 2, 1),
    (2000009, 1001003, 'grade', '职级管理', 2, 2, 1, 4, 1),
    (2000010, 1001004, 'settings', '系统设置', 2, 2, 1, 2, 1),
    (2000011, 1001004, 'config', '参数管理', 2, 2, 1, 2, 1),
    (2000012, 1001004, 'role', '角色管理', 2, 2, 1, 2, 1),
    (2000013, 1001004, 'authority', '权限管理', 2, 2, 1, 1, 1),
    (2000014, 1001004, 'agreement', '协议管理', 2, 2, 1, 1, 1),
    (2000015, 1001004, 'dict', '字典管理', 2, 2, 1, 1, 1),
    (2000016, 1001004, 'tag', '标签管理', 2, 2, 1, 2, 1),
    (2000017, 1001004, 'catalog', '分类管理', 2, 2, 1, 2, 1),
    (2000018, 1001004, 'area', '地区管理', 2, 2, 1, 3, 1),
    (2000019, 1001004, 'keyword', '关键字管理', 2, 2, 1, 3, 1),
    (2000020, 1001006, 'session', '在线用户', 2, 2, 1, 1, 1),
    (2000021, 1001006, 'log:operation', '操作日志', 2, 2, 1, 5, 1),
    (2000022, 1001006, 'log:login', '登录日志', 2, 2, 1, 5, 1),
    (2000023, 1001005, 'message:setting', '基本设置', 2, 2, 1, 5, 1),
    (2000024, 1001005, 'message:template', '消息模版', 2, 2, 1, 5, 1),
    (2000025, 1001005, 'message:log', '消息日志', 2, 2, 1, 5, 1),
    /* -------- 平台设置 -------- */
    (2001001, 1001009, 'platform:settings', '基本设置', 2, 1, 1, 3, 1),
    (2001002, 1001009, 'platform:config', '参数管理', 2, 1, 1, 3, 1),
    (2001003, 1001009, 'platform:role', '角色管理', 2, 1, 1, 2, 1),
    (2001004, 1001009, 'platform:authority', '权限管理', 2, 1, 1, 1, 1),
    (2001005, 1001009, 'platform:user', '用户', 2, 1, 1, 1, 1),
    (2001006, 1001009, 'platform:agreement', '协议管理', 2, 1, 1, 2, 1),
    (2001007, 1001009, 'platform:dict', '字典管理', 2, 1, 1, 1, 1),
    (2001008, 1001009, 'platform:tag', '标签管理', 2, 1, 1, 2, 1),
    (2001009, 1001009, 'platform:catalog', '分类管理', 2, 1, 1, 2, 1),
    (2001010, 1001009, 'platform:area', '地区管理', 2, 1, 1, 3, 1),
    (2001011, 1001009, 'platform:keyword', '关键字管理', 2, 1, 1, 3, 1),
    (2001012, 1001009, 'platform:attachment', '附件管理', 2, 1, 1, 3, 1),
    (2001013, 1001009, 'platform:application', '应用管理', 2, 1, 1, 3, 1),
    (2001014, 1001010, 'platform:tenant', '租户管理', 2, 1, 1, 4, 1),
    (2001015, 1001010, 'platform:tenant:settings', '租户设置', 2, 1, 1, 4, 1),
    (2001016, 1001010, 'platform:tenant:order', '租户订单', 2, 1, 1, 4, 1),
    (2001017, 1001010, 'platform:tenant:log', '租户日志', 2, 1, 1, 4, 1),
    (2001018, 1001011, 'platform:member', '会员管理', 2, 1, 1, 11, 1),
    (2001019, 1001011, 'platform:member:setting', '会员设置', 2, 1, 1, 11, 1),
    (2001020, 1001011, 'platform:member:order', '会员订单', 2, 1, 1, 11, 1),
    (2001021, 1001011, 'platform:member:log', '会员日志', 2, 1, 1, 4, 1),
    (2001022, 1001012, 'platform:session', '在线用户', 2, 1, 1, 1, 1),
    (2001023, 1001012, 'platform:log:operation', '操作日志', 2, 1, 1, 5, 1),
    (2001024, 1001012, 'platform:log:login', '登录日志', 2, 1, 1, 5, 1),
    /* -------- 开放平台 -------- */
    (2002001, 1001015, 'open:wechat:mp', '微信公众号列表', 2, 2, 1, 11, 1),
    (2002002, 1001016, 'open:wechat:ma', '微信小程序列表', 2, 2, 1, 11, 1),
    /* -------- 数据统计和数据分析 -------- */
    (2003001, 1001013, 'data:dashboard', '驾驶舱', 2, 2, 1, 1, 0),
    (2003002, 1001013, 'data:statistics', '数据统计', 2, 2, 1, 1, 0),
    (2003004, 1001013, 'data:analysis', '数据分析', 2, 2, 1, 1, 0),
    (2003003, 1001014, 'data:report', '数据报表', 2, 2, 1, 1, 0),
    /* -------- 开发工具 -------- */
    (2004001, 1001021, 'development:tools:i18n', '多语言文本', 2, 1, 1, 5, 1),
    (2004002, 1001021, 'development:tools:generator', '代码生成器', 2, 1, 1, 5, 1),
    (2004003, 1001021, 'development:tools:docs', '接口文档', 2, 1, 1, 5, 1),
    (2004004, 1001021, 'development:tools:test', '测试工具', 2, 1, 1, 5, 1),
    (2004005, 1001022, 'development:gateway:rule', '限流规则', 2, 1, 1, 5, 1),
    (2004006, 1001022, 'development:gateway:limit', '限流名单', 2, 1, 1, 5, 1),
    (2004007, 1001022, 'development:gateway:router', '网关路由', 2, 1, 1, 5, 1),
    (2004008, 1001023, 'development:monitor:system', '系统监控', 2, 1, 1, 4, 1),
    (2004009, 1001023, 'development:monitor:job', '定时任务', 2, 1, 1, 5, 1),
    (2004010, 1001023, 'development:monitor:cache', '缓存监控', 2, 1, 1, 5, 1),
    (2004011, 1001023, 'development:monitor:log', '日志中心', 2, 1, 1, 5, 1),
    (2004012, 1001023, 'development:monitor:config', '配置中心', 2, 1, 1, 5, 1),
    (2004013, 1001023, 'development:monitor:datasource', '数据源', 2, 1, 1, 5, 1),
    (2004014, 1001023, 'development:monitor:transaction', '分布式事务', 2, 1, 1, 5, 1);
...
values (1000001, 'ALIPAY', '支付宝', 'ant-design:alipay-outlined', 0),
       ...
       (1000003, 'USDT', 'USDT', 'cryptocurrency-color:usdt', 0);
