...
import cn.elvea.platform.system.security.repository.AuthorizationMapper;
...
public class AuthorizationServiceImpl extends BaseCachingEntityService<AuthorizationEntity, Long, AuthorizationMapper> implements AuthorizationService {
    ...
    public AuthorizationEntity findByState(String state) {
        AuthorizationEntity entity = this.lambdaQuery().eq(AuthorizationEntity::getState, state).one();
        setCache(entity);
        return entity;
    }
    ...
    public AuthorizationEntity findByAuthorizationCodeValue(String authorizationCodeValue) {
        AuthorizationEntity entity = this.lambdaQuery().eq(AuthorizationEntity::getAuthorizationCodeValue, authorizationCodeValue).one();
        setCache(entity);
        return entity;
    }
    ...
    public AuthorizationEntity findByOidcIdTokenValue(String oidcIdTokenValue) {
        AuthorizationEntity entity = this.lambdaQuery().eq(AuthorizationEntity::getOidcIdTokenValue, oidcIdTokenValue).one();
        setCache(entity);
        return entity;
    }
    ...
    public AuthorizationEntity findByAccessTokenValue(String accessTokenValue) {
        AuthorizationEntity entity = this.lambdaQuery().eq(AuthorizationEntity::getAccessTokenValue, accessTokenValue).one();
        setCache(entity);
        return entity;
    }
    ...
    public AuthorizationEntity findByRefreshTokenValue(String refreshTokenValue) {
        AuthorizationEntity entity = this.lambdaQuery().eq(AuthorizationEntity::getRefreshTokenValue, refreshTokenValue).one();
        setCache(entity);
        return entity;
    }
