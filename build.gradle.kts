...
allprojects {
    ...
    dependencyManagement {
        ...
        dependencies {
            ...
            dependency("com.openai:openai-java:2.9.0")
            dependency("com.larksuite.oapi:oapi-sdk:2.4.18")
            ...
            // sdk - aliyun
            dependency("com.aliyun:dingtalk:2.2.24")
            ...
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-common:3.1.1288")
            ...
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-hunyuan:3.1.1288")
            // commons
