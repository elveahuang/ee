...
allprojects {
    ...
    dependencyManagement {
        imports {
            ...
            mavenBom("cn.hutool:hutool-bom:5.8.36")
            mavenBom("me.ahoo.cosid:cosid-bom:2.12.1")
        ...
        dependencies {
            ...
            dependency("com.github.oshi:oshi-core-java11:6.7.1")
            ...
            dependency("net.bytebuddy:byte-buddy:1.17.2")
            dependency("net.bytebuddy:byte-buddy-agent:1.17.2")
            ...
            dependency("com.alibaba:fastjson:2.0.56")
            dependency("com.google.code.gson:gson:2.12.1")
            dependency("com.google.protobuf:protobuf-java:4.30.1")
            ...
            dependency("com.larksuite.oapi:oapi-sdk:2.4.12")
            ...
            dependency("org.telegram:telegrambots-client:8.2.0")
            dependency("org.telegram:telegrambots-abilities:8.2.0")
            dependency("org.telegram:telegrambots-springboot-longpolling-starter:8.2.0")
            // sdk - ai
            dependency("com.openai:openai-java:0.34.1")
            // sdk - aliyun
            dependency("com.aliyun:dingtalk:2.1.98")
            ...
            dependency("com.alibaba:dashscope-sdk-java:2.18.5")
            dependency("com.aliyun:aliyun-java-sdk-core:4.7.3")
            dependency("com.alipay.sdk:alipay-sdk-java:4.40.82.ALL")
            // sdk - tencent
            dependency("com.qcloud:cos_api:5.6.244.2")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-common:3.1.1222")
            ...
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-hunyuan:3.1.1221")
            // commons
