...
allprojects {
    ...
    dependencyManagement {
        ...
        dependencies {
            ...
            dependency("org.redisson:redisson-spring-data-35:3.48.0")
            dependency("org.redisson:redisson-spring-boot-starter:3.48.0")
            ...
            // sdk - ai
            dependency("com.openai:openai-java:2.3.0")
            // sdk - aliyun
            ...
            dependency("com.alipay.sdk:alipay-sdk-java:4.40.233.ALL")
            // sdk - tencent
            dependency("com.qcloud:cos_api:5.6.246")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-common:3.1.1270")
