...
allprojects {
    ...
    dependencyManagement {
        imports {
            ...
            mavenBom("me.ahoo.cosid:cosid-bom:2.8.3")
        ...
        dependencies {
            ...
            dependency("com.google.protobuf:protobuf-java:4.27.1")
            ...
            dependency("net.bytebuddy:byte-buddy:1.14.17")
            dependency("net.bytebuddy:byte-buddy-agent:1.14.17")
            ...
            dependency("com.larksuite.oapi:oapi-sdk:2.2.9")
