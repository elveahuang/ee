...
allprojects {
    ...
    dependencyManagement {
        ...
        dependencies {
            ...
            dependency("com.google.code.gson:gson:2.13.0")
            ...
            dependency("com.larksuite.oapi:oapi-sdk:2.4.14")
            ...
            // sdk - ai
            dependency("com.openai:openai-java:1.4.1")
            // sdk - aliyun
            dependency("com.aliyun:dingtalk:2.2.14")
            dependency("com.aliyun:alimt20181012:1.4.0")
            dependency("com.aliyun:facebody20191230:5.1.2")
            dependency("com.aliyun:dysmsapi20170525:4.0.0")
            dependency("com.aliyun.oss:aliyun-sdk-oss:3.18.1")
            dependency("com.alibaba:dashscope-sdk-java:2.19.2")
            dependency("com.aliyun:aliyun-java-sdk-core:4.7.5")
            dependency("com.alipay.sdk:alipay-sdk-java:4.40.165.ALL")
            // sdk - tencent
            dependency("com.qcloud:cos_api:5.6.245")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-common:3.1.1245")
            ...
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-hunyuan:3.1.1245")
            // commons
