...
allprojects {
    ...
    dependencyManagement {
        ...
        dependencies {
            ...
            dependency("io.swagger.core.v3:swagger-core-jakarta:2.2.23")
            dependency("io.swagger.core.v3:swagger-annotations:2.2.23")
            dependency("io.swagger.core.v3:swagger-annotations-jakarta:2.2.23")
            dependency("io.swagger.core.v3:swagger-models:2.2.23")
            dependency("io.swagger.core.v3:swagger-models-jakarta:2.2.23")
            ...
            dependency("com.aliyun:ecs20140526:5.4.2")
