...
allprojects {
    ...
    dependencyManagement {
        ...
        dependencies {
            ...
            dependency("org.redisson:redisson-spring-data-33:3.34.0")
            ...
            dependency("org.dromara.x-easypdf:x-easypdf:3.1.0")
            dependency("org.dromara.x-easypdf:x-easypdf-pdfbox:3.1.0")
