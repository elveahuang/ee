...
allprojects {
    ...
    dependencyManagement {
        ...
        dependencies {
            ...
            dependency("io.swagger.core.v3:swagger-core-jakarta:2.2.21")
            dependency("io.swagger.core.v3:swagger-annotations:2.2.21")
            dependency("io.swagger.core.v3:swagger-annotations-jakarta:2.2.21")
            dependency("io.swagger.core.v3:swagger-models:2.2.21")
            dependency("io.swagger.core.v3:swagger-models-jakarta:2.2.21")
            ...
            dependency("org.redisson:redisson:3.30.0")
            dependency("org.redisson:redisson-spring-data-32:3.30.0")
            dependency("org.redisson:redisson-spring-boot-starter:3.30.0")
            // others
            dependency("com.nimbusds:nimbus-jose-jwt:9.39.1")
            dependency("com.nimbusds:oauth2-oidc-sdk:11.12")
            dependency("org.json:json:20240303")
            dependency("com.alibaba:fastjson:2.0.50")
            ...
            dependency("com.google.protobuf:protobuf-java:4.26.1")
            ...
            dependency("org.libreoffice:juh:7.6.4")
            dependency("org.libreoffice:jurt:7.6.4")
            dependency("org.libreoffice:ridl:7.6.4")
            dependency("org.libreoffice:unoil:7.6.4")
            ...
            dependency("com.aliyun:dingtalk:2.1.18")
