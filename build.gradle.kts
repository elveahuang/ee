...
allprojects {
    ...
    dependencyManagement {
        ...
        dependencies {
            ...
            dependency("net.bytebuddy:byte-buddy:1.17.4")
            dependency("net.bytebuddy:byte-buddy-agent:1.17.4")
            ...
            // sdk - ai
            dependency("com.openai:openai-java:0.36.0")
            // sdk - aliyun
            dependency("com.aliyun:dingtalk:2.1.99")
            ...
            dependency("com.alipay.sdk:alipay-sdk-java:4.40.104.ALL")
            // sdk - tencent
            dependency("com.qcloud:cos_api:5.6.244.2")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-common:3.1.1227")
            ...
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-hunyuan:3.1.1226")
            // commons
