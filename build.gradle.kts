...
allprojects {
    ...
    dependencyManagement {
        imports {
            ...
            mavenBom("com.tencent.cloud:spring-cloud-tencent-dependencies:1.11.9-2022.0.1")
            mavenBom("de.codecentric:spring-boot-admin-dependencies:3.1.5")
            mavenBom("io.grpc:grpc-bom:1.57.2")
            mavenBom("cn.hutool:hutool-bom:5.8.21")
            mavenBom("me.ahoo.cosid:cosid-bom:2.5.0")
