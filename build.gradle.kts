...
allprojects {
    ...
    dependencyManagement {
        ...
        dependencies {
            ...
            dependency("io.swagger.core.v3:swagger-core-jakarta:2.2.31")
            dependency("io.swagger.core.v3:swagger-annotations:2.2.31")
            dependency("io.swagger.core.v3:swagger-annotations-jakarta:2.2.31")
            dependency("io.swagger.core.v3:swagger-models:2.2.31")
            dependency("io.swagger.core.v3:swagger-models-jakarta:2.2.31")
            dependency("org.springdoc:springdoc-openapi-starter-common:2.8.8")
            dependency("org.springdoc:springdoc-openapi-starter-webmvc-ui:2.8.8")
            dependency("org.springdoc:springdoc-openapi-starter-webflux-ui:2.8.8")
            // database & nosql
            ...
            dependency("com.larksuite.oapi:oapi-sdk:2.4.17")
            ...
            dependency("cn.felord:wecom-sdk:1.3.4")
            dependency("cn.felord:wemp-sdk:1.3.4")
            dependency("cn.felord:wepay-sdk:1.3.4")
            ...
            // sdk - ai
            dependency("com.openai:openai-java:2.7.0")
            // sdk - aliyun
            dependency("com.aliyun:dingtalk:2.2.21")
            ...
            dependency("com.alibaba:dashscope-sdk-java:2.20.3")
            dependency("com.aliyun:aliyun-java-sdk-core:4.7.6")
            dependency("com.alipay.sdk:alipay-sdk-java:4.40.251.ALL")
            // sdk - tencent
            dependency("com.qcloud:cos_api:5.6.247")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-common:3.1.1280")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-kms:3.1.1242")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-sms:3.1.1280")
            ...
            dependency("org.checkerframework:checker-qual:3.49.3")
