...
allprojects {
    ...
    dependencyManagement {
        ...
        dependencies {
            ...
            dependency("com.baomidou:mybatis-plus:3.5.4")
            dependency("com.baomidou:mybatis-plus-annotation:3.5.4")
            dependency("com.baomidou:mybatis-plus-core:3.5.4")
            dependency("com.baomidou:mybatis-plus-extension:3.5.4")
            dependency("com.baomidou:mybatis-plus-generator:3.5.4")
            dependency("com.baomidou:mybatis-plus-boot-starter:3.5.4")
            dependency("org.apache.shardingsphere:shardingsphere-jdbc-core:5.4.1")
            dependency("com.github.jsqlparser:jsqlparser:4.6")
            dependency("org.redisson:redisson:3.24.2")
            dependency("org.redisson:redisson-spring-data-31:3.24.2")
            ...
            dependency("com.github.oshi:oshi-core:6.4.6")
            dependency("com.github.oshi:oshi-core-java11:6.4.6")
            ...
            dependency("com.google.protobuf:protobuf-java:3.24.4")
            ...
            dependency("org.apache.poi:poi-ooxml-lite:5.2.4")
            ...
            dependency("com.aliyun:dingtalk:2.0.48")
            dependency("com.aliyun:imm20170906:1.23.8")
            dependency("com.aliyun:facebody20191230:5.0.1")
