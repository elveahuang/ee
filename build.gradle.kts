...
allprojects {
    ...
    dependencyManagement {
        imports {
            mavenBom("de.codecentric:spring-boot-admin-dependencies:3.4.3")
        ...
        dependencies {
            ...
            dependency("com.nimbusds:oauth2-oidc-sdk:11.23")
            ...
            dependency("org.telegram:telegrambots-longpolling:8.2.0")
            dependency("org.telegram:telegrambots-webhook:8.2.0")
            ...
            dependency("org.telegram:telegrambots-springboot-webhook-starter:8.2.0")
            // sdk - ai
            ...
            dependency("com.alipay.sdk:alipay-sdk-java:4.40.64.ALL")
            // sdk - tencent
            dependency("com.qcloud:cos_api:5.6.242")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-common:3.1.1201")
            ...
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-hunyuan:3.1.1200")
            // commons
