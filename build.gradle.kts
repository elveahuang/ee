...
allprojects {
    ...
    dependencyManagement {
        ...
        dependencies {
            ...
            dependency("org.redisson:redisson:3.24.1")
            dependency("org.redisson:redisson-spring-data-31:3.24.1")
            dependency("org.redisson:redisson-spring-boot-starter:3.24.1")
            // others
