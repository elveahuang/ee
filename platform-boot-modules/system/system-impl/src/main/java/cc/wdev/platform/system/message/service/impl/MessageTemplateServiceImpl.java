...
import cc.wdev.platform.system.message.cache.MessageTemplateCacheKeyGenerator;
import cc.wdev.platform.system.message.domain.entity.MessageTemplateEntity;
import cc.wdev.platform.system.message.domain.entity.MessageTemplateEntity_;
