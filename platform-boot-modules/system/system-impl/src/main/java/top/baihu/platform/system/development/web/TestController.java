package top.baihu.platform.system.development.web;
...
import top.baihu.platform.commons.message.broadcast.manager.BroadcastManager;
import top.baihu.platform.commons.web.controller.AbstractController;
import top.baihu.platform.system.development.broadcast.TestBroadcastMessage;

import java.io.Serializable;
import java.time.LocalDateTime;
import java.util.Date;

import static top.baihu.platform.system.commons.constants.SystemMappingConstants.API_V1__TEST__DATE;
import static top.baihu.platform.system.commons.constants.SystemMappingConstants.API_V1__TEST__MESSAGE;
