...
import top.baihu.platform.commons.utils.*;
...
import top.baihu.platform.system.message.domain.dto.MessageUserDto;
...
import top.baihu.platform.system.message.domain.entity.*;
...
import top.baihu.platform.system.message.enums.MessageUserTypeEnum;
import top.baihu.platform.system.message.sender.*;
import top.baihu.platform.system.message.service.*;

import java.util.Arrays;
import java.util.Collections;
import java.util.List;

import static top.baihu.platform.system.commons.constants.SystemMessageConstants.TPL_CLASSPATH;
...
public class MessageManagerImpl implements MessageManager {
    ...
    /**
     * @see MessageManager#createMessage(CreateMessageDto)
     */
    @Override
     ...
     *
     * @see MessageManager#sendMessage()
     */
    @Override
    ...
    /**
     * @see MessageManager#sendMessage(Long)
     */
    @Override
    ...
    /**
     * @see MessageManager#sendMessage(Long, boolean)
     */
    @Override
    ...
    /**
     * @see MessageManager#initTemplate()
     */
    @Override
    ...
    /**
     * @see MessageManager#syncTemplate(boolean)
     */
    @Override
