...
import top.baihu.platform.system.core.domain.dto.UserForgotPasswordDto;
...
public class UserManagerImpl implements UserManager {
    ...
    /**
     * @see UserManager#register(UserRegisterForm)
     */
    @Override
    ...
    /**
     * @see UserManager#updateAccount(UserBaseForm)
     */
    @Override
    ...
    /**
     * @see UserManager#forgotPassword(UserForgotPasswordForm)
     */
    @Override
    ...
    /**
     * @see UserManager#resetPassword(UserResetPasswordForm)
     */
    @Override
    ...
    /**
     * @see UserManager#changePassword(UserChangePasswordForm)
     */
    @Override
    ...
    /**
     * @see UserManager#changeEmail(UserChangeEmailForm)
     */
    @Override
