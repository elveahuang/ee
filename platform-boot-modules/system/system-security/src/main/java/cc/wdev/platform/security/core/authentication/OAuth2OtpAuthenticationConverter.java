...
public class OAuth2OtpAuthenticationConverter implements AuthenticationConverter {
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        if (!CustomAuthorizationGrantType.OTP.getValue().equals(grantType)) {
            return null;
        }
        ...
        // code (REQUIRED)
        OAuth2EndpointUtils.checkRequiredParameter(parameters, CustomParameterNames.VERIFY_CODE_KEY);
        OAuth2EndpointUtils.checkRequiredParameter(parameters, CustomParameterNames.VERIFY_CODE_VALUE);
        ...
        return new OAuth2OtpAuthenticationToken(clientPrincipal, requestedScopes, additionalParameters);
    }
