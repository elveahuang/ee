...
import cc.wdev.platform.system.core.feign.LoginSessionApi;
...
import cc.wdev.platform.system.security.feign.AuthorizationApi;
        ...
        try {
            ...
            if (user != null) {
                LoginSessionDto userSession = LoginSessionDto.builder()
                    ...
                    .build();
                this.loginSessionApi.saveUserSession(userSession);
            }
        } catch (Exception e) {
